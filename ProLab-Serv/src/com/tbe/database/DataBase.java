...
public class DataBase {
	...
	private static String strCreateUserTable = "Create table users (id integer primary key autoincrement, username char(20), password char(20), firstname char(20), surname char(20));";
